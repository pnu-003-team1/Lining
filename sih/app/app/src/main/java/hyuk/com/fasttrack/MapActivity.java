...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button numButton = (Button)findViewById(R.id.nunButton);
        Button addrButton = (Button)findViewById(R.id.addrButton);
        Button mb1 = (Button)findViewById(R.id.mapButton1);
        Button mb2 = (Button)findViewById(R.id.mapButton2);
...
//                                  list.get(0).getLongitude();    // 경도
                        tv.setText(list.get(0).getLatitude() + ", " + list.get(0).getLongitude());
                    }
                }
            }
        });
